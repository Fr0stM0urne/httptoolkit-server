...
function parseScutilOutput(output) {
    try {
        ...
        throw Object.assign(new Error("Unexpected scutil proxy output format"), { scutilOutput: output } // Attach output for debugging elsewhere
        );
    }
}
exports.parseScutilOutput = parseScutilOutput;
//# sourceMappingURL=parse-scutil.js.map